 ...
 * @file: The name of the buffer file storing characters
 *
...
/**
 * close_file - Close the descriptors file
...
/**
 * main - Copy the contents of the file to another one
 * @argc: The NUM of argu supplied to the program
 * @argv: An ARRAY of pointers to the argu
 *
 * Return: IF success return 0
 *
 * Description: exit code 97 If the argu count is incorrect
