 ...
 * @e_ident: Pointer to an ARRAY containing the ELF magic NUMS
 *
...
/**
 * print_magic - Print the magic NUMS of an ELF header
 * @e_ident: Pointer to an ARRAY containing the ELF magic NUMS
 *
 * Description: Magic NUMS must be separated by spaces
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_entry: The address of the ELF point of entry
 * @e_ident: Pointer to an ARRAY containing the ELF class
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 * @elf: The descriptor file  of the ELF file
 *
...
/**
 * main - Display the information in the
 * ELF header at the start of the ELF file
 * @argc: The NUMS of argu supplied in the program
